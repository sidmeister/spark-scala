object LearningScala3 {
  ...
  def UpperCaseIt(str: String) : String = {
    str.toUpperCase();
  }

  def transformtoUpperCase(str: String, f: String => String) : String = {
    f(str);
  }

  transformtoUpperCase("sid",UpperCaseIt);

  transformtoUpperCase("sid", str => str.toUpperCase);

  println (UpperCaseIt("sid"))
